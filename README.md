...
Crossing a task off plays a short pen scratch, generated by `scripts/make-sound.swift`. Turn it off with "Sounds" in the notch menu; it also stays quiet when "Play user interface sound effects" is off in System Settings.
